...
# 配置参数
input_folder = r"/mnt/raid/zhengsen/wildfire_dataset/self_built_materials/Reflection_500_merge_mergeTerraAqua"  # 输入文件夹路径
output_folder = r"/mnt/raid/zhengsen/wildfire_dataset/self_built_materials/Reflection_500_merge_mergeTerraAqua_reshapeResize"  # 输出文件夹路径
...
def reproject_and_resample(input_path, output_path):
    ...
    with rasterio.open(input_path) as src:
        ...
        kwargs.update({
            ...
            'dtype': rasterio.float32  # 设置数据类型为float64
        })
