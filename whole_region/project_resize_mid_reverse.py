...
# 配置参数
input_folder = r"/mnt/raid/zhengsen/wildfire_dataset/self_built_materials/ERA5/raw_data"  # 输入文件夹路径
output_folder = r"/mnt/raid/zhengsen/wildfire_dataset/self_built_materials/ERA5/resize_500"  # 输出文件夹路径
...
# 批量处理所有文件
raster_files = raster_files[:len(raster_files)//2]  # 反转文件列表
raster_files.reverse()
