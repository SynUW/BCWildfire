...
# 配置参数
input_folder = r"/mnt/raid/zhengsen/wildfire_dataset/self_built_materials/ERA5/daily/ERA5"  # 输入文件夹路径
output_folder = r"/mnt/raid/zhengsen/wildfire_dataset/self_built_materials/ERA5/DAILY_500"  # 输出文件夹路径
