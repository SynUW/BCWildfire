...
if __name__ == "__main__":
    # 设置路径 (根据实际情况修改)
    input_folder = r"/mnt/raid/zhengsen/wildfire_dataset/self_built_materials/FIRMS/Firms_Terra_500_Daily_WGS84"
    output_folder = r"/mnt/raid/zhengsen/wildfire_dataset/self_built_materials/FIRMS/Firms_Terra_500_Daily_WGS84_resize"
